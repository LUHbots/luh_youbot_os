...
#ifndef LUH_YOUBOT_MANIPULATION_API_GRIPPER_H
#define LUH_YOUBOT_MANIPULATION_API_GRIPPER_H
 ...
 *
 * // initialise gripper
 * manipulation_api::YoubotGripper gripper;
...
public:
     ...
     * @details The object has to be listed in the configuration file of the gripper module in luh_youbot_manipulation.
...
#endif // LUH_YOUBOT_MANIPULATION_API_GRIPPER_H
