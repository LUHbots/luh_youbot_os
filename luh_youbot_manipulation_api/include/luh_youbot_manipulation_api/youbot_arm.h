...
#ifndef LUH_YOUBOT_MANIPULATION_API_ARM_H
#define LUH_YOUBOT_MANIPULATION_API_ARM_H
 ...
 *
 * // initialise gripper
 * manipulation_api::YoubotArm arm;
 ...
 *
 * arm.moveToPose(relative_pos, manipulation_api::MotionMode::INTERPOLATE, true);
 *
...
#endif // LUH_YOUBOT_MANIPULATION_API_ARM_H
