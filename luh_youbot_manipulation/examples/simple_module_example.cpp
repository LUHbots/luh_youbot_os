#include "luh_youbot_manipulation/module_example/simple_module_example.h"


//########## CONSTRUCTOR ###############################################################################################
ModuleExample::ModuleExample(): ManipulationModule() // don't forget to call base class constuctor!
{
}
...
void ModuleExample::update()
{
    ...
    manipulation_msgs::JointVector joint_pose_msg;
