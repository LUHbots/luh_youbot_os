...
#ifndef LUH_YOUBOT_MANIPULATION_MODULE_DIRECT_CONTROL_H
#define LUH_YOUBOT_MANIPULATION_MODULE_DIRECT_CONTROL_H
...
class ModuleDirectControl : public ManipulationModule
{
public:
    ModuleDirectControl();
    ~ModuleDirectControl();
