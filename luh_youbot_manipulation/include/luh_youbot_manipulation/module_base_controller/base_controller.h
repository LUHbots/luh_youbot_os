...
#ifndef LUH_YOUBOT_MANIPULATION_MODULE_BASE_CONTROLLER_H
#define LUH_YOUBOT_MANIPULATION_MODULE_BASE_CONTROLLER_H
...
class ModuleBaseController : public ManipulationModule
{
public:
